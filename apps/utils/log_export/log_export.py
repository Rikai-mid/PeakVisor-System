...
def lambda_handler(event, context):
    ...
    extra_args = {}
    log_groups = []
    log_groups_to_export = os.environ['LOG_GROUPS'].split(",")
    ...
    for log_group_name in log_groups_to_export:
        ssm_parameter_name = ("/log-exporter-last-export/%s" %
        ...
        print("--> Exporting %s to %s" %
              (log_group_name, os.environ['S3_BUCKET']))
